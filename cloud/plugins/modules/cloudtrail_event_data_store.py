...
def main():
    ...
    argument_spec['advanced_event_selectors'] = {'type': 'list', 'elements': 'dict', 'options': {'name': {'type': 'str'}, 'field_selectors': {'type': 'list', 'elements': 'dict', 'options': {'field': {'type': 'str'}, 'equals': {'type': 'list', 'elements': 'str'}, 'starts_with': {'type': 'list', 'elements': 'str'}, 'ends_with': {'type': 'list', 'elements': 'str'}, 'not_equals': {'type': 'list', 'elements': 'str'}, 'not_starts_with': {'type': 'list', 'elements': 'str'}, 'not_ends_with': {'type': 'list', 'elements': 'str'}}}}}
    ...
    required_if = [
        ['state', 'present', ['event_data_store_arn'], True],['state', 'absent', ['event_data_store_arn'], True],['state', 'get', ['event_data_store_arn'], True]
    ]
    mutually_exclusive = [
    ...
    params['termination_protection_enabled'] = module.params.get('termination_protection_enabled')
