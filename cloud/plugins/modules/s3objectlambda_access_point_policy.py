...
def main():
    ...
    required_if = [
        ['state', 'present', ['object_lambda_access_point', 'policy_document'], True],['state', 'absent', ['object_lambda_access_point'], True],['state', 'get', ['object_lambda_access_point'], True]
    ]
    mutually_exclusive = [
    ...
    params['object_lambda_access_point'] = module.params.get('object_lambda_access_point')
