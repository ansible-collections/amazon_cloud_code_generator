...
def main():
    ...
    argument_spec['resolve_conflicts'] = {'type': 'str', 'choices': ['NONE', 'OVERWRITE', 'PRESERVE']}
    ...
    required_if = [
        ['state', 'list', ['cluster_name'], True],['state', 'present', ['cluster_name', 'addon_name', 'identifier'], True],['state', 'absent', ['cluster_name', 'addon_name', 'identifier'], True],['state', 'get', ['cluster_name', 'addon_name', 'identifier'], True]
    ]
    mutually_exclusive = [
        [('cluster_name', 'addon_name'), 'identifier']
    ]
