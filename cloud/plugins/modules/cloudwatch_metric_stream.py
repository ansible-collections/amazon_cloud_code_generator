...
def main():
    ...
    argument_spec['statistics_configurations'] = {'type': 'list', 'elements': 'dict', 'options': {'include_metrics': {'type': 'list', 'elements': 'dict', 'options': {'metric_name': {'type': 'str'}, 'namespace': {'type': 'str'}}}, 'additional_statistics': {'type': 'list', 'elements': 'str'}}}
    argument_spec['firehose_arn'] = {'type': 'str'}
    argument_spec['output_format'] = {'type': 'str'}
    argument_spec['exclude_filters'] = {'type': 'list', 'elements': 'dict', 'options': {'namespace': {'type': 'str'}}}
    argument_spec['role_arn'] = {'type': 'str'}
    argument_spec['name'] = {'type': 'str'}
    argument_spec['include_filters'] = {'type': 'list', 'elements': 'dict', 'options': {'namespace': {'type': 'str'}}}
    ...
    required_if = [
        ['state', 'present', ['firehose_arn', 'output_format', 'name', 'role_arn'], True],['state', 'absent', ['name'], True],['state', 'get', ['name'], True]
    ]
    mutually_exclusive = [
