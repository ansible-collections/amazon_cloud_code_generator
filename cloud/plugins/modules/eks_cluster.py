...
def main():
    ...
    argument_spec['encryption_config'] = {'type': 'list', 'elements': 'dict', 'options': {'provider': {'type': 'dict', 'options': {'key_arn': {'type': 'str'}}}, 'resources': {'type': 'list', 'elements': 'str'}}}
    argument_spec['kubernetes_network_config'] = {'type': 'dict', 'options': {'service_ipv4_cidr': {'type': 'str'}, 'ip_family': {'type': 'str', 'choices': ['ipv4', 'ipv6']}}}
    argument_spec['logging'] = {'type': 'dict', 'options': {'cluster_logging': {'type': 'dict', 'options': {'enabled_types': {'type': 'list', 'elements': 'dict', 'options': {'type': {'type': 'str', 'choices': ['api', 'audit', 'authenticator', 'controllerManager', 'scheduler']}}}}}}}
    argument_spec['name'] = {'type': 'str'}
    argument_spec['resources_vpc_config'] = {'type': 'dict', 'options': {'endpoint_private_access': {'type': 'bool'}, 'endpoint_public_access': {'type': 'bool'}, 'public_access_cidrs': {'type': 'list', 'elements': 'str'}, 'security_group_ids': {'type': 'list', 'elements': 'str'}, 'subnet_ids': {'type': 'list', 'elements': 'str'}}}
    argument_spec['outpost_config'] = {'type': 'dict', 'options': {'outpost_arns': {'type': 'list', 'elements': 'str'}, 'control_plane_instance_type': {'type': 'str'}, 'control_plane_placement': {'type': 'dict', 'options': {'group_name': {'type': 'str'}}}}}
    ...
    required_if = [
        ['state', 'present', ['resources_vpc_config', 'name', 'role_arn'], True],['state', 'absent', ['name'], True],['state', 'get', ['name'], True]
    ]
    mutually_exclusive = [
    ...
    create_only_params = ['outpost_config', 'encryption_config', 'kubernetes_network_config', 'name', 'role_arn', 'subnet_ids', 'security_group_ids']
