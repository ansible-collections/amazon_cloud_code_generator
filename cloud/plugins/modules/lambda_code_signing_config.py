...
def main():
    ...
    argument_spec['allowed_publishers'] = {'type': 'dict', 'options': {'signing_profile_version_arns': {'type': 'list', 'elements': 'str'}}}
    argument_spec['code_signing_policies'] = {'type': 'dict', 'options': {'untrusted_artifact_on_deployment': {'type': 'str', 'default': 'Warn', 'choices': ['Enforce', 'Warn']}}}
    ...
    required_if = [
        ['state', 'present', ['allowed_publishers', 'code_signing_config_arn'], True],['state', 'absent', ['code_signing_config_arn'], True],['state', 'get', ['code_signing_config_arn'], True]
    ]
    mutually_exclusive = [
