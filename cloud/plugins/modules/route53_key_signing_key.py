...
def main():
    ...
    required_if = [
        ['state', 'list', ['hosted_zone_id'], True],['state', 'present', ['identifier', 'key_management_service_arn', 'status', 'name', 'hosted_zone_id'], True],['state', 'absent', ['hosted_zone_id', 'name', 'identifier'], True],['state', 'get', ['hosted_zone_id', 'name', 'identifier'], True]
    ]
    mutually_exclusive = [
        [('hosted_zone_id', 'name'), 'identifier']
    ]
    ...
    params['key_management_service_arn'] = module.params.get('key_management_service_arn')
