...
def main():
    ...
    argument_spec['policies'] = {'type': 'list', 'elements': 'dict', 'options': {'policy_document': {'type': 'str'}, 'policy_name': {'type': 'str'}}}
    ...
    required_if = [
        ['state', 'present', ['role_name', 'assume_role_policy_document'], True],['state', 'absent', ['role_name'], True],['state', 'get', ['role_name'], True]
    ]
    mutually_exclusive = [
