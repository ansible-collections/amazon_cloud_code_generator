...
def main():
    ...
    argument_spec['target_role'] = {'type': 'str', 'choices': ['READ_ONLY', 'READ_WRITE']}
    ...
    required_if = [
        ['state', 'present', ['db_proxy_name', 'db_proxy_endpoint_name', 'vpc_subnet_ids'], True],['state', 'absent', ['db_proxy_endpoint_name'], True],['state', 'get', ['db_proxy_endpoint_name'], True]
    ]
    mutually_exclusive = [
    ...
    create_only_params = ['db_proxy_name', 'db_proxy_endpoint_name', 'vpc_subnet_ids', 'target_role']
