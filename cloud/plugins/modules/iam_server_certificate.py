...
def main():
    ...
    required_if = [
        ['state', 'present', ['server_certificate_name'], True],['state', 'absent', ['server_certificate_name'], True],['state', 'get', ['server_certificate_name'], True]
    ]
    mutually_exclusive = [
    ...
    create_only_params = ['server_certificate_name', 'private_key', 'certificate_body', 'certificate_chain']
