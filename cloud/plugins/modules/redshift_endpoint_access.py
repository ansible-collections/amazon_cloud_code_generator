...
def main():
    ...
    argument_spec['vpc_security_groups'] = {'type': 'list', 'elements': 'dict', 'options': {}}
    ...
    argument_spec['vpc_endpoint'] = {'type': 'dict', 'options': {'network_interfaces': {'type': 'list', 'elements': 'dict', 'options': {}}}}
    ...
    required_if = [
        ['state', 'present', ['subnet_group_name', 'cluster_identifier', 'vpc_security_group_ids', 'endpoint_name'], True],['state', 'absent', ['endpoint_name'], True],['state', 'get', ['endpoint_name'], True]
    ]
    mutually_exclusive = [
    ...
    params['vpc_endpoint'] = module.params.get('vpc_endpoint')
    ...
    create_only_params = ['endpoint_name', 'cluster_identifier', 'resource_owner', 'subnet_group_name']
