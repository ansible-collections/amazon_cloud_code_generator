...
def main():
    ...
    argument_spec['bucket_account_id'] = {'type': 'str'}
    argument_spec['vpc_configuration'] = {'type': 'dict', 'options': {'vpc_id': {'type': 'str'}}}
    argument_spec['public_access_block_configuration'] = {'type': 'dict', 'options': {'block_public_acls': {'type': 'bool'}, 'ignore_public_acls': {'type': 'bool'}, 'block_public_policy': {'type': 'bool'}, 'restrict_public_buckets': {'type': 'bool'}}}
    argument_spec['policy'] = {'type': 'dict'}
    argument_spec['policy_status'] = {'type': 'dict', 'options': {'is_public': {'type': 'str', 'choices': ['false', 'true']}}}
    ...
    required_if = [
        ['state', 'present', ['bucket', 'name'], True],['state', 'absent', ['name'], True],['state', 'get', ['name'], True]
    ]
    mutually_exclusive = [
    ...
    create_only_params = ['name', 'bucket', 'bucket_account_id', 'vpc_configuration', 'public_access_block_configuration']
