...
def main():
    ...
    argument_spec['target_action'] = {'type': 'dict', 'options': {'resize_cluster': {'type': 'dict', 'options': {'cluster_identifier': {'type': 'str'}, 'cluster_type': {'type': 'str'}, 'node_type': {'type': 'str'}, 'number_of_nodes': {'type': 'int'}, 'classic': {'type': 'bool'}}}, 'pause_cluster': {'type': 'dict', 'options': {'cluster_identifier': {'type': 'str'}}}, 'resume_cluster': {'type': 'dict', 'options': {'cluster_identifier': {'type': 'str'}}}}}
    ...
    required_if = [
        ['state', 'present', ['scheduled_action_name'], True],['state', 'absent', ['scheduled_action_name'], True],['state', 'get', ['scheduled_action_name'], True]
    ]
    mutually_exclusive = [
    ...
    params['scheduled_action_description'] = module.params.get('scheduled_action_description')
