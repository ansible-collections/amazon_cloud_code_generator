...
def main():
    ...
    argument_spec['public_access_block_configuration'] = {'type': 'dict', 'options': {'restrict_public_buckets': {'type': 'bool'}, 'block_public_policy': {'type': 'bool'}, 'block_public_acls': {'type': 'bool'}, 'ignore_public_acls': {'type': 'bool'}}}
    argument_spec['regions'] = {'type': 'list', 'elements': 'dict', 'options': {'bucket': {'type': 'str'}}}
    ...
    required_if = [
        ['state', 'present', ['regions', 'name'], True],['state', 'absent', ['name'], True],['state', 'get', ['name'], True]
    ]
    mutually_exclusive = [
    ...
    handlers = ['read', 'create', 'list', 'delete']
