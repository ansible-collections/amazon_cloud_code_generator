...
def main():
    ...
    required_if = [
        ['state', 'present', ['alarm_rule', 'alarm_name'], True],['state', 'absent', ['alarm_name'], True],['state', 'get', ['alarm_name'], True]
    ]
    mutually_exclusive = [
    ...
    params['actions_suppressor_extension_period'] = module.params.get('actions_suppressor_extension_period')
    params['actions_suppressor_wait_period'] = module.params.get('actions_suppressor_wait_period')
