...
def main():
    ...
    argument_spec['source_type'] = {'type': 'str', 'choices': ['cluster', 'cluster-parameter-group', 'cluster-security-group', 'cluster-snapshot', 'scheduled-action']}
    argument_spec['source_ids'] = {'type': 'list', 'elements': 'str'}
    argument_spec['event_categories'] = {'type': 'list', 'elements': 'str', 'choices': ['configuration', 'management', 'monitoring', 'pending', 'security']}
    ...
    required_if = [
        ['state', 'present', ['subscription_name'], True],['state', 'absent', ['subscription_name'], True],['state', 'get', ['subscription_name'], True]
    ]
    mutually_exclusive = [
