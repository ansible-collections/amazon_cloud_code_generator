...
def main():
    ...
    argument_spec['notifications'] = {'type': 'dict', 'options': {'backup_vault_events': {'type': 'list', 'elements': 'str'}, 'sns_topic_arn': {'type': 'str'}}}
    argument_spec['lock_configuration'] = {'type': 'dict', 'options': {'min_retention_days': {'type': 'int'}, 'max_retention_days': {'type': 'int'}, 'changeable_for_days': {'type': 'int'}}}
    ...
    required_if = [
        ['state', 'present', ['backup_vault_name'], True],['state', 'absent', ['backup_vault_name'], True],['state', 'get', ['backup_vault_name'], True]
    ]
    mutually_exclusive = [
