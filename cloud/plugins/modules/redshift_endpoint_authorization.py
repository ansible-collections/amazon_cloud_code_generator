...
def main():
    ...
    required_if = [
        ['state', 'list', ['cluster_identifier'], True],['state', 'present', ['identifier', 'cluster_identifier', 'account'], True],['state', 'absent', ['cluster_identifier', 'account', 'identifier'], True],['state', 'get', ['cluster_identifier', 'account', 'identifier'], True]
    ]
    mutually_exclusive = [
        [('cluster_identifier', 'account'), 'identifier']
    ]
    ...
    if state in ('present', 'absent', 'get', 'describe') and module.params.get('identifier') is None:
        if not  module.params.get('cluster_identifier') or not module.params.get('account'):
