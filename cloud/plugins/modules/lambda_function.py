...
def main():
    ...
    argument_spec['tracing_config'] = {'type': 'dict', 'options': {'mode': {'type': 'str', 'choices': ['Active', 'PassThrough']}}}
    argument_spec['vpc_config'] = {'type': 'dict', 'options': {'security_group_ids': {'type': 'list', 'elements': 'str'}, 'subnet_ids': {'type': 'list', 'elements': 'str'}}}
    argument_spec['reserved_concurrent_executions'] = {'type': 'int'}
    argument_spec['snap_start'] = {'type': 'dict', 'options': {}}
    argument_spec['file_system_configs'] = {'type': 'list', 'elements': 'dict', 'options': {'local_mount_path': {'type': 'str'}}}
    ...
    argument_spec['image_config'] = {'type': 'dict', 'options': {'working_directory': {'type': 'str'}, 'command': {'type': 'list', 'elements': 'str'}, 'entry_point': {'type': 'list', 'elements': 'str'}}}
    argument_spec['memory_size'] = {'type': 'int'}
    argument_spec['dead_letter_config'] = {'type': 'dict', 'options': {'target_arn': {'type': 'str'}}}
    argument_spec['timeout'] = {'type': 'int'}
    argument_spec['handler'] = {'type': 'str'}
    argument_spec['code'] = {'type': 'dict', 'options': {'s3_object_version': {'type': 'str'}, 's3_bucket': {'type': 'str'}, 'zip_file': {'type': 'str'}, 's3_key': {'type': 'str'}, 'image_uri': {'type': 'str'}}}
    argument_spec['role'] = {'type': 'str'}
    argument_spec['environment'] = {'type': 'dict', 'options': {'variables': {'type': 'dict'}}}
    argument_spec['ephemeral_storage'] = {'type': 'dict', 'options': {'size': {'type': 'int'}}}
    argument_spec['architectures'] = {'type': 'list', 'elements': 'str', 'choices': ['arm64', 'x86_64']}
    ...
    required_if = [
        ['state', 'present', ['function_name', 'code', 'role'], True],['state', 'absent', ['function_name'], True],['state', 'get', ['function_name'], True]
    ]
    mutually_exclusive = [
    ...
    params['reserved_concurrent_executions'] = module.params.get('reserved_concurrent_executions')
