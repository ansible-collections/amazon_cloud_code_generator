...
def main():
    ...
    argument_spec['report_plan_tags'] = {'type': 'list', 'elements': 'dict', 'options': {'key': {'type': 'str'}, 'value': {'type': 'str'}}}
    argument_spec['report_delivery_channel'] = {'type': 'dict', 'options': {'formats': {'type': 'list', 'elements': 'str'}, 's3_bucket_name': {'type': 'str'}, 's3_key_prefix': {'type': 'str'}}}
    argument_spec['report_setting'] = {'type': 'dict', 'options': {'report_template': {'type': 'str'}, 'framework_arns': {'type': 'list', 'elements': 'str'}}}
    ...
    required_if = [
        ['state', 'present', ['report_setting', 'report_delivery_channel', 'report_plan_arn'], True],['state', 'absent', ['report_plan_arn'], True],['state', 'get', ['report_plan_arn'], True]
    ]
    mutually_exclusive = [
