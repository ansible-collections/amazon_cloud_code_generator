...
def main():
    ...
    argument_spec['accelerate_configuration'] = {'type': 'dict', 'options': {'acceleration_status': {'type': 'str', 'choices': ['Enabled', 'Suspended']}}}
    ...
    argument_spec['analytics_configurations'] = {'type': 'list', 'elements': 'dict', 'options': {'tag_filters': {'type': 'list', 'elements': 'dict', 'options': {'value': {'type': 'str'}, 'key': {'type': 'str'}}}, 'storage_class_analysis': {'type': 'dict', 'options': {'data_export': {'type': 'dict', 'options': {'destination': {'type': 'dict', 'options': {'bucket_arn': {'type': 'str'}, 'bucket_account_id': {'type': 'str'}, 'format': {'type': 'str', 'choices': ['CSV', 'ORC', 'Parquet']}, 'prefix': {'type': 'str'}}}, 'output_schema_version': {'type': 'str', 'default': 'V_1'}}}}}, 'id': {'type': 'str'}, 'prefix': {'type': 'str'}}}
    argument_spec['bucket_encryption'] = {'type': 'dict', 'options': {'server_side_encryption_configuration': {'type': 'list', 'elements': 'dict', 'options': {'bucket_key_enabled': {'type': 'bool'}, 'server_side_encryption_by_default': {'type': 'dict', 'options': {'kms_master_key_id': {'type': 'str'}, 'sse_algorithm': {'type': 'str', 'choices': ['AES256', 'aws:kms']}}}}}}}
    argument_spec['bucket_name'] = {'type': 'str'}
    argument_spec['cors_configuration'] = {'type': 'dict', 'options': {'cors_rules': {'type': 'list', 'elements': 'dict', 'options': {'allowed_headers': {'type': 'list', 'elements': 'str'}, 'allowed_methods': {'type': 'list', 'elements': 'str', 'choices': ['DELETE', 'GET', 'HEAD', 'POST', 'PUT']}, 'allowed_origins': {'type': 'list', 'elements': 'str'}, 'exposed_headers': {'type': 'list', 'elements': 'str'}, 'id': {'type': 'str'}, 'max_age': {'type': 'int'}}}}}
    argument_spec['intelligent_tiering_configurations'] = {'type': 'list', 'elements': 'dict', 'options': {'id': {'type': 'str'}, 'prefix': {'type': 'str'}, 'status': {'type': 'str', 'choices': ['Disabled', 'Enabled']}, 'tag_filters': {'type': 'list', 'elements': 'dict', 'options': {'value': {'type': 'str'}, 'key': {'type': 'str'}}}, 'tierings': {'type': 'list', 'elements': 'dict', 'options': {'access_tier': {'type': 'str', 'choices': ['ARCHIVE_ACCESS', 'DEEP_ARCHIVE_ACCESS']}, 'days': {'type': 'int'}}}}}
    argument_spec['inventory_configurations'] = {'type': 'list', 'elements': 'dict', 'options': {'destination': {'type': 'dict', 'options': {'bucket_arn': {'type': 'str'}, 'bucket_account_id': {'type': 'str'}, 'format': {'type': 'str', 'choices': ['CSV', 'ORC', 'Parquet']}, 'prefix': {'type': 'str'}}}, 'enabled': {'type': 'bool'}, 'id': {'type': 'str'}, 'included_object_versions': {'type': 'str', 'choices': ['All', 'Current']}, 'optional_fields': {'type': 'list', 'elements': 'str', 'choices': ['BucketKeyStatus', 'ETag', 'EncryptionStatus', 'IntelligentTieringAccessTier', 'IsMultipartUploaded', 'LastModifiedDate', 'ObjectLockLegalHoldStatus', 'ObjectLockMode', 'ObjectLockRetainUntilDate', 'ReplicationStatus', 'Size', 'StorageClass']}, 'prefix': {'type': 'str'}, 'schedule_frequency': {'type': 'str', 'choices': ['Daily', 'Weekly']}}}
    argument_spec['lifecycle_configuration'] = {'type': 'dict', 'options': {'rules': {'type': 'list', 'elements': 'dict', 'options': {'abort_incomplete_multipart_upload': {'type': 'dict', 'options': {'days_after_initiation': {'type': 'int'}}}, 'expiration_date': {'type': 'str'}, 'expiration_in_days': {'type': 'int'}, 'expired_object_delete_marker': {'type': 'bool'}, 'id': {'type': 'str'}, 'noncurrent_version_expiration_in_days': {'type': 'int'}, 'noncurrent_version_expiration': {'type': 'dict', 'options': {'noncurrent_days': {'type': 'int'}, 'newer_noncurrent_versions': {'type': 'int'}}}, 'noncurrent_version_transition': {'type': 'dict', 'options': {'storage_class': {'type': 'str', 'choices': ['DEEP_ARCHIVE', 'GLACIER', 'GLACIER_IR', 'Glacier', 'INTELLIGENT_TIERING', 'ONEZONE_IA', 'STANDARD_IA']}, 'transition_in_days': {'type': 'int'}, 'newer_noncurrent_versions': {'type': 'int'}}}, 'noncurrent_version_transitions': {'type': 'list', 'elements': 'dict', 'options': {'storage_class': {'type': 'str', 'choices': ['DEEP_ARCHIVE', 'GLACIER', 'GLACIER_IR', 'Glacier', 'INTELLIGENT_TIERING', 'ONEZONE_IA', 'STANDARD_IA']}, 'transition_in_days': {'type': 'int'}, 'newer_noncurrent_versions': {'type': 'int'}}}, 'prefix': {'type': 'str'}, 'status': {'type': 'str', 'choices': ['Disabled', 'Enabled']}, 'tag_filters': {'type': 'list', 'elements': 'dict', 'options': {'value': {'type': 'str'}, 'key': {'type': 'str'}}}, 'object_size_greater_than': {'type': 'str'}, 'object_size_less_than': {'type': 'str'}, 'transition': {'type': 'dict', 'options': {'storage_class': {'type': 'str', 'choices': ['DEEP_ARCHIVE', 'GLACIER', 'GLACIER_IR', 'Glacier', 'INTELLIGENT_TIERING', 'ONEZONE_IA', 'STANDARD_IA']}, 'transition_date': {'type': 'str'}, 'transition_in_days': {'type': 'int'}}}, 'transitions': {'type': 'list', 'elements': 'dict', 'options': {'storage_class': {'type': 'str', 'choices': ['DEEP_ARCHIVE', 'GLACIER', 'GLACIER_IR', 'Glacier', 'INTELLIGENT_TIERING', 'ONEZONE_IA', 'STANDARD_IA']}, 'transition_date': {'type': 'str'}, 'transition_in_days': {'type': 'int'}}}}}}}
    argument_spec['logging_configuration'] = {'type': 'dict', 'options': {'destination_bucket_name': {'type': 'str'}, 'log_file_prefix': {'type': 'str'}}}
    argument_spec['metrics_configurations'] = {'type': 'list', 'elements': 'dict', 'options': {'access_point_arn': {'type': 'str'}, 'id': {'type': 'str'}, 'prefix': {'type': 'str'}, 'tag_filters': {'type': 'list', 'elements': 'dict', 'options': {'value': {'type': 'str'}, 'key': {'type': 'str'}}}}}
    argument_spec['notification_configuration'] = {'type': 'dict', 'options': {'event_bridge_configuration': {'type': 'dict', 'options': {'event_bridge_enabled': {'type': 'bool', 'default': 'true'}}}, 'lambda_configurations': {'type': 'list', 'elements': 'dict', 'options': {'event': {'type': 'str'}, 'filter': {'type': 'dict', 'options': {'s3_key': {'type': 'dict', 'options': {'rules': {'type': 'list', 'elements': 'dict', 'options': {'name': {'type': 'str'}, 'value': {'type': 'str'}}}}}}}, 'function': {'type': 'str'}}}, 'queue_configurations': {'type': 'list', 'elements': 'dict', 'options': {'event': {'type': 'str'}, 'filter': {'type': 'dict', 'options': {'s3_key': {'type': 'dict', 'options': {'rules': {'type': 'list', 'elements': 'dict', 'options': {'name': {'type': 'str'}, 'value': {'type': 'str'}}}}}}}, 'queue': {'type': 'str'}}}, 'topic_configurations': {'type': 'list', 'elements': 'dict', 'options': {'event': {'type': 'str'}, 'filter': {'type': 'dict', 'options': {'s3_key': {'type': 'dict', 'options': {'rules': {'type': 'list', 'elements': 'dict', 'options': {'name': {'type': 'str'}, 'value': {'type': 'str'}}}}}}}, 'topic': {'type': 'str'}}}}}
    argument_spec['object_lock_configuration'] = {'type': 'dict', 'options': {'object_lock_enabled': {'type': 'str', 'default': 'Enabled'}, 'rule': {'type': 'dict', 'options': {'default_retention': {'type': 'dict', 'options': {'years': {'type': 'int'}, 'days': {'type': 'int'}, 'mode': {'type': 'str', 'choices': ['COMPLIANCE', 'GOVERNANCE']}}}}}}}
    argument_spec['object_lock_enabled'] = {'type': 'bool'}
    argument_spec['ownership_controls'] = {'type': 'dict', 'options': {'rules': {'type': 'list', 'elements': 'dict', 'options': {'object_ownership': {'type': 'str', 'choices': ['BucketOwnerEnforced', 'BucketOwnerPreferred', 'ObjectWriter']}}}}}
    argument_spec['public_access_block_configuration'] = {'type': 'dict', 'options': {'block_public_acls': {'type': 'bool'}, 'block_public_policy': {'type': 'bool'}, 'ignore_public_acls': {'type': 'bool'}, 'restrict_public_buckets': {'type': 'bool'}}}
    argument_spec['replication_configuration'] = {'type': 'dict', 'options': {'role': {'type': 'str'}, 'rules': {'type': 'list', 'elements': 'dict', 'options': {'delete_marker_replication': {'type': 'dict', 'options': {'status': {'type': 'str', 'choices': ['Disabled', 'Enabled']}}}, 'destination': {'type': 'dict', 'options': {'access_control_translation': {'type': 'dict', 'options': {'owner': {'type': 'str', 'default': 'Destination'}}}, 'account': {'type': 'str'}, 'bucket': {'type': 'str'}, 'encryption_configuration': {'type': 'dict', 'options': {'replica_kms_key_id': {'type': 'str'}}}, 'metrics': {'type': 'dict', 'options': {'event_threshold': {'type': 'dict', 'options': {'minutes': {'type': 'int'}}}, 'status': {'type': 'str', 'choices': ['Disabled', 'Enabled']}}}, 'replication_time': {'type': 'dict', 'options': {'status': {'type': 'str', 'choices': ['Disabled', 'Enabled']}, 'time': {'type': 'dict', 'options': {'minutes': {'type': 'int'}}}}}, 'storage_class': {'type': 'str', 'choices': ['DEEP_ARCHIVE', 'GLACIER', 'GLACIER_IR', 'INTELLIGENT_TIERING', 'ONEZONE_IA', 'REDUCED_REDUNDANCY', 'STANDARD', 'STANDARD_IA']}}}, 'filter': {'type': 'dict', 'options': {'and': {'type': 'dict', 'options': {'prefix': {'type': 'str'}, 'tag_filters': {'type': 'list', 'elements': 'dict', 'options': {'value': {'type': 'str'}, 'key': {'type': 'str'}}}}}, 'prefix': {'type': 'str'}, 'tag_filter': {'type': 'dict', 'options': {'value': {'type': 'str'}, 'key': {'type': 'str'}}}}}, 'id': {'type': 'str'}, 'prefix': {'type': 'str'}, 'priority': {'type': 'int'}, 'source_selection_criteria': {'type': 'dict', 'options': {'replica_modifications': {'type': 'dict', 'options': {'status': {'type': 'str', 'choices': ['Disabled', 'Enabled']}}}, 'sse_kms_encrypted_objects': {'type': 'dict', 'options': {'status': {'type': 'str', 'choices': ['Disabled', 'Enabled']}}}}}, 'status': {'type': 'str', 'choices': ['Disabled', 'Enabled']}}}}}
    argument_spec['tags'] = {'type': 'dict', 'aliases': ['resource_tags']}
    argument_spec['versioning_configuration'] = {'type': 'dict', 'options': {'status': {'type': 'str', 'default': 'Suspended', 'choices': ['Enabled', 'Suspended']}}}
    argument_spec['website_configuration'] = {'type': 'dict', 'options': {'error_document': {'type': 'str'}, 'index_document': {'type': 'str'}, 'routing_rules': {'type': 'list', 'elements': 'dict', 'options': {'redirect_rule': {'type': 'dict', 'options': {'host_name': {'type': 'str'}, 'http_redirect_code': {'type': 'str'}, 'protocol': {'type': 'str', 'choices': ['http', 'https']}, 'replace_key_prefix_with': {'type': 'str'}, 'replace_key_with': {'type': 'str'}}}, 'routing_rule_condition': {'type': 'dict', 'options': {'key_prefix_equals': {'type': 'str'}, 'http_error_code_returned_equals': {'type': 'str'}}}}}, 'redirect_all_requests_to': {'type': 'dict', 'options': {'host_name': {'type': 'str'}, 'protocol': {'type': 'str', 'choices': ['http', 'https']}}}}}
    ...
    required_if = [
        ['state', 'present', ['bucket_name'], True],['state', 'absent', ['bucket_name'], True],['state', 'get', ['bucket_name'], True]
    ]
    mutually_exclusive = [
